      ...
      <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
        ...
        <div className="grid grid-cols-1 gap-4 mb-4">
          <div>
            ...
            <label className="text-gray-500 cursor-pointer" htmlFor="storeData"> Save name, email in this browser.</label>
          </div>
        </div>
        {error && <p className="text-xs text-red-500">All fields are mandatory</p>}
        <div className="mt-8">
          <button type="button" onClick={handlePostSubmission} className="transition duration-500 ease hover:bg-indigo-900 inline-block bg-gray-500 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Post Comment</button>
